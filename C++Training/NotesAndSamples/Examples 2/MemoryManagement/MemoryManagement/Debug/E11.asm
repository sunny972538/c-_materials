; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E11.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??1SA@Ex11@@QAE@XZ				; Ex11::SA::~SA
...
;	COMDAT rtc$TMZ
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e11.cpp
rtc$TMZ	SEGMENT
...
; 25   : 	SA *p1 = new(buffer) SA(); 
	...
	cmp	DWORD PTR $T30055[ebp], 0
	je	SHORT $LN3@main
	mov	ecx, DWORD PTR $T30055[ebp]
...
; 27   : 	SA *p3 = new(buffer + 10) SA(); 
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T30061[ebp], eax
	cmp	DWORD PTR $T30061[ebp], 0
	je	SHORT $LN7@main
...
; 28   : 
; 29   : 	//never call delete 
; 30   : 	p1->SA::~SA();

	mov	ecx, DWORD PTR _p1$[ebp]
	call	??1SA@Ex11@@QAE@XZ			; Ex11::SA::~SA
...
; 34   : 	int *pi = new(buffer) int;
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T30064[ebp], eax
	mov	ecx, DWORD PTR $T30064[ebp]
	mov	DWORD PTR _pi$[ebp], ecx

; 35   : 
; 36   : 	delete[] buffer; //if it is heap

	mov	eax, DWORD PTR _buffer$[ebp]
	mov	DWORD PTR $T30065[ebp], eax
...
PUBLIC	??_C@_04OPLAHJMN@dtor?$AA@			; `string'
EXTRN	__imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z:PROC
EXTRN	__imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A:BYTE
EXTRN	__imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z:PROC
;	COMDAT ??_C@_04OPLAHJMN@dtor?$AA@
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e11.cpp
CONST	SEGMENT
??_C@_04OPLAHJMN@dtor?$AA@ DB 'dtor', 00H		; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??1SA@Ex11@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1SA@Ex11@@QAE@XZ PROC					; Ex11::SA::~SA, COMDAT
; _this$ = ecx
...
; 12   : 			cout<<"dtor"<<endl;
	...
	push	eax
	push	OFFSET ??_C@_04OPLAHJMN@dtor?$AA@
...
; 13   : 		}
	...
	pop	ebp
	ret	0
??1SA@Ex11@@QAE@XZ ENDP					; Ex11::SA::~SA
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30083[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30084[ebp], edx
	lea	eax, DWORD PTR $T30083[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30084[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30085[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30086[ebp], edx
	lea	eax, DWORD PTR $T30085[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30086[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
