; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E05.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?flag@Ex5@@3_NA					; Ex5::flag
_BSS	SEGMENT
?flag@Ex5@@3_NA DB 01H DUP (?)				; Ex5::flag
_BSS	ENDS
...
CONST	ENDS
PUBLIC	??0CA@Ex5@@QAE@XZ				; Ex5::CA::CA
PUBLIC	?fun@Ex5@@YAXXZ					; Ex5::fun
EXTRN	__RTC_CheckEsp:PROC
EXTRN	@_RTC_CheckStackVars@8:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e05.cpp
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ?fun@Ex5@@YAXXZ
_TEXT	SEGMENT
_obj2$23180 = -20					; size = 4
_obj$ = -8						; size = 4
?fun@Ex5@@YAXXZ PROC					; Ex5::fun, COMDAT
...
; 17   : 		CA obj;
	...
	call	??0CA@Ex5@@QAE@XZ			; Ex5::CA::CA

; 18   : 
; 19   : 		if(flag)

	movzx	eax, BYTE PTR ?flag@Ex5@@3_NA		; Ex5::flag
	test	eax, eax
	je	SHORT $LN2@fun
...
; 21   : 			CA obj2;
	...
	lea	ecx, DWORD PTR _obj2$23180[ebp]
	call	??0CA@Ex5@@QAE@XZ			; Ex5::CA::CA
$LN2@fun:
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??0CA@Ex5@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0CA@Ex5@@QAE@XZ PROC					; Ex5::CA::CA, COMDAT
; _this$ = ecx

; 10   : 		CA()		{			cout<<"CA created"<<endl;		}
	...
	pop	ebp
	ret	0
??0CA@Ex5@@QAE@XZ ENDP					; Ex5::CA::CA
_TEXT	ENDS
PUBLIC	?main5@@YAXXZ					; main5
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?main5@@YAXXZ
_TEXT	SEGMENT
?main5@@YAXXZ PROC					; main5, COMDAT
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30062[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30063[ebp], edx
	lea	eax, DWORD PTR $T30062[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30063[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30064[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30065[ebp], edx
	lea	eax, DWORD PTR $T30064[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30065[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
