; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E44.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??_GGeneration@Ex44@@QAEPAXI@Z			; Ex44::Generation::`scalar deleting destructor'
PUBLIC	?Allocate@Generation@Ex44@@QAEPAXI@Z		; Ex44::Generation::Allocate
PUBLIC	??0Generation@Ex44@@QAE@H@Z			; Ex44::Generation::Generation
PUBLIC	?main44@@YAXXZ					; main44
...
;	COMDAT xdata$x
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e44.cpp
xdata$x	SEGMENT
__unwindtable$?main44@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?main44@@YAXXZ$0
__ehfuncinfo$?main44@@YAXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?main44@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_g1$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?main44@@YAXXZ PROC					; main44, COMDAT
...
; 46   : 	Generation* g1 = new Generation(0);

	push	268					; 0000010cH
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T38338[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T38338[ebp], 0
	je	SHORT $LN3@main44
	push	0
	mov	ecx, DWORD PTR $T38338[ebp]
	call	??0Generation@Ex44@@QAE@H@Z		; Ex44::Generation::Generation
	mov	DWORD PTR tv72[ebp], eax
	jmp	SHORT $LN4@main44
$LN3@main44:
...
; 47   : 	
; 48   : 	int* pi = (int*) g1->Allocate(4);

	push	4
	mov	ecx, DWORD PTR _g1$[ebp]
	call	?Allocate@Generation@Ex44@@QAEPAXI@Z	; Ex44::Generation::Allocate
	mov	DWORD PTR _pi$[ebp], eax

; 49   : 	double* pd = (double*) g1->Allocate(8);
...
; 52   : 	delete g1;
	...
	mov	DWORD PTR $T38342[ebp], eax
	mov	ecx, DWORD PTR $T38342[ebp]
	mov	DWORD PTR $T38341[ebp], ecx
	cmp	DWORD PTR $T38341[ebp], 0
	je	SHORT $LN5@main44
	push	1
	mov	ecx, DWORD PTR $T38341[ebp]
	call	??_GGeneration@Ex44@@QAEPAXI@Z
	mov	DWORD PTR tv84[ebp], eax
	jmp	SHORT $LN1@main44
$LN5@main44:
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?main44@@YAXXZ$0:
	mov	eax, DWORD PTR $T38338[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?main44@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-296]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?main44@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?main44@@YAXXZ ENDP					; main44
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??0Generation@Ex44@@QAE@H@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_no$ = 8						; size = 4
??0Generation@Ex44@@QAE@H@Z PROC			; Ex44::Generation::Generation, COMDAT
; _this$ = ecx
...
; 19   : 			cout<<"Created generation "<<id<<endl;
...
; 20   : 		}
	...
	pop	ebp
	ret	4
??0Generation@Ex44@@QAE@H@Z ENDP			; Ex44::Generation::Generation
_TEXT	ENDS
...
PUBLIC	?GetFreeSpace@Generation@Ex44@@QAEIXZ		; Ex44::Generation::GetFreeSpace
...
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?Allocate@Generation@Ex44@@QAEPAXI@Z
_TEXT	SEGMENT
tv156 = -240						; size = 4
$T38370 = -232						; size = 12
_temp$ = -20						; size = 4
_this$ = -8						; size = 4
_size$ = 8						; size = 4
?Allocate@Generation@Ex44@@QAEPAXI@Z PROC		; Ex44::Generation::Allocate, COMDAT
; _this$ = ecx
...
; 27   : 			if(size > GetFreeSpace())

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetFreeSpace@Generation@Ex44@@QAEIXZ	; Ex44::Generation::GetFreeSpace
	cmp	DWORD PTR _size$[ebp], eax
	jbe	SHORT $LN1@Allocate

; 28   : 				throw bad_alloc();

	lea	ecx, DWORD PTR $T38370[ebp]
	call	??0bad_alloc@std@@QAE@XZ		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T38370[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Allocate:

; 29   : 		
; 30   : 			char* temp = cur;	//save cur 

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+260]
	mov	DWORD PTR _temp$[ebp], ecx

; 31   : 			cur += size;		//set cur to next free memory
...
; 32   : 
; 33   : 			cout<<"allocated "<<size<<" at "<< (void*)temp<<" on gen "<<id<<endl;
...
; 35   : 		}
	...
	pop	ebp
	ret	4
?Allocate@Generation@Ex44@@QAEPAXI@Z ENDP		; Ex44::Generation::Allocate
_TEXT	ENDS
...
; 350  : 		{	// construct from message string with no memory allocation
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T38374[ebp], OFFSET ??_C@_0P@GHFPNOJB@bad?5allocation?$AA@
	mov	esi, esp
	push	1
	lea	eax, DWORD PTR $T38374[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e44.cpp
_TEXT	ENDS
;	COMDAT ?GetFreeSpace@Generation@Ex44@@QAEIXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?GetFreeSpace@Generation@Ex44@@QAEIXZ PROC		; Ex44::Generation::GetFreeSpace, COMDAT
; _this$ = ecx
...
; 24   : 		}
	...
	pop	ebp
	ret	0
?GetFreeSpace@Generation@Ex44@@QAEIXZ ENDP		; Ex44::Generation::GetFreeSpace
_TEXT	ENDS
...
_TEXT	ENDS
PUBLIC	??1Generation@Ex44@@QAE@XZ			; Ex44::Generation::~Generation
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??_GGeneration@Ex44@@QAEPAXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
___flags$ = 8						; size = 4
??_GGeneration@Ex44@@QAEPAXI@Z PROC			; Ex44::Generation::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??1Generation@Ex44@@QAE@XZ		; Ex44::Generation::~Generation
	mov	eax, DWORD PTR ___flags$[ebp]
	and	eax, 1
...
$LN1@scalar@2:
	...
	pop	ebp
	ret	4
??_GGeneration@Ex44@@QAEPAXI@Z ENDP			; Ex44::Generation::`scalar deleting destructor'
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??1Generation@Ex44@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1Generation@Ex44@@QAE@XZ PROC				; Ex44::Generation::~Generation, COMDAT
; _this$ = ecx
...
; 38   : 			cout<<"destroyed generation "<<id<<endl;	
...
; 39   : 		}
	...
	pop	ebp
	ret	0
??1Generation@Ex44@@QAE@XZ ENDP				; Ex44::Generation::~Generation
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T38392[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T38393[ebp], edx
	lea	eax, DWORD PTR $T38392[ebp]
	push	eax
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T38394[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T38395[ebp], edx
	lea	eax, DWORD PTR $T38394[ebp]
	push	eax
