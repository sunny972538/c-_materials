; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E10.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e10.cpp
CONST	SEGMENT
...
$T30039 = -212						; size = 4
_p$ = -8						; size = 4
?main10@@YAXXZ PROC					; main10, COMDAT
...
; 15   : 	SA *p = new(nothrow) SA(); 

	mov	DWORD PTR $T30035[ebp], 1
	push	OFFSET ?nothrow@std@@3Unothrow_t@1@B	; std::nothrow
	mov	eax, DWORD PTR $T30035[ebp]
	push	eax
	call	??2@YAPAXIABUnothrow_t@std@@@Z		; operator new
	add	esp, 8
	mov	DWORD PTR $T30036[ebp], eax
	cmp	DWORD PTR $T30036[ebp], 0
	je	SHORT $LN4@main10
	mov	ecx, DWORD PTR $T30035[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR $T30036[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
	mov	eax, DWORD PTR $T30036[ebp]
	mov	DWORD PTR tv68[ebp], eax
	jmp	SHORT $LN5@main10
$LN4@main10:
...
; 17   : 	if(p == 0)
	...
	jne	SHORT $LN1@main10

; 18   : 	{
; 19   : 		cout<<"out of memory"<<endl;
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30054[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30055[ebp], edx
	lea	eax, DWORD PTR $T30054[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30055[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30056[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30057[ebp], edx
	lea	eax, DWORD PTR $T30056[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30057[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
