; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E29.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_09EEMLFLCF@?5pointer?5?$AA@		; `string'
PUBLIC	??_C@_0M@BBHGFBDH@?5points?5to?5?$AA@		; `string'
...
PUBLIC	?TraversePointers@Ex29@@YAXXZ			; Ex29::TraversePointers
...
;	COMDAT ??_C@_09EEMLFLCF@?5pointer?5?$AA@
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e29.cpp
CONST	SEGMENT
??_C@_09EEMLFLCF@?5pointer?5?$AA@ DB ' pointer ', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@BBHGFBDH@?5points?5to?5?$AA@
CONST	SEGMENT
??_C@_0M@BBHGFBDH@?5points?5to?5?$AA@ DB ' points to ', 00H ; `string'
CONST	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ?TraversePointers@Ex29@@YAXXZ
_TEXT	SEGMENT
_i$32001 = -8						; size = 4
?TraversePointers@Ex29@@YAXXZ PROC			; Ex29::TraversePointers, COMDAT
...
; 11   : 		for(int i=0;i < stack.size(); i++)
	...
	mov	DWORD PTR _i$32001[ebp], 0
	jmp	SHORT $LN3@TraversePo
$LN2@TraversePo:
	mov	eax, DWORD PTR _i$32001[ebp]
	add	eax, 1
	mov	DWORD PTR _i$32001[ebp], eax
$LN3@TraversePo:
	mov	ecx, OFFSET ?stack@Ex29@@3V?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@A ; Ex29::stack
	call	?size@?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@QBEIXZ ; std::vector<void * *,std::allocator<void * *> >::size
	cmp	DWORD PTR _i$32001[ebp], eax
	jae	$LN4@TraversePo

; 12   : 		{
; 13   : 			cout<<" pointer "<< stack[i] <<" points to "<<*stack[i] <<endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	mov	ecx, DWORD PTR _i$32001[ebp]
	push	ecx
	mov	ecx, OFFSET ?stack@Ex29@@3V?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@A ; Ex29::stack
	...
	push	eax
	push	OFFSET ??_C@_0M@BBHGFBDH@?5points?5to?5?$AA@
	mov	ecx, DWORD PTR _i$32001[ebp]
	push	ecx
	mov	ecx, OFFSET ?stack@Ex29@@3V?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@A ; Ex29::stack
	call	??A?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@QAEAAPAPAXI@Z ; std::vector<void * *,std::allocator<void * *> >::operator[]
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	push	OFFSET ??_C@_09EEMLFLCF@?5pointer?5?$AA@
...
; 15   : 	}
	...
	pop	ebp
	ret	0
?TraversePointers@Ex29@@YAXXZ ENDP			; Ex29::TraversePointers
_TEXT	ENDS
PUBLIC	??1?$Ptr@H@Ex29@@QAE@XZ				; Ex29::Ptr<int>::~Ptr<int>
PUBLIC	??1?$Ptr@N@Ex29@@QAE@XZ				; Ex29::Ptr<double>::~Ptr<double>
PUBLIC	??0?$Ptr@H@Ex29@@QAE@AAV01@@Z			; Ex29::Ptr<int>::Ptr<int>
PUBLIC	??0?$Ptr@N@Ex29@@QAE@PAN@Z			; Ex29::Ptr<double>::Ptr<double>
PUBLIC	__real@0000000000000000
PUBLIC	??0?$Ptr@H@Ex29@@QAE@PAH@Z			; Ex29::Ptr<int>::Ptr<int>
PUBLIC	_main
...
; 41   : 	Ptr<int> p1 = new int();

	push	4
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T39368[ebp], eax
	cmp	DWORD PTR $T39368[ebp], 0
	je	SHORT $LN3@main
	mov	eax, DWORD PTR $T39368[ebp]
	mov	DWORD PTR [eax], 0
	mov	ecx, DWORD PTR $T39368[ebp]
...
$LN4@main:
	...
	call	??0?$Ptr@H@Ex29@@QAE@PAH@Z		; Ex29::Ptr<int>::Ptr<int>
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 42   : 
; 43   : 	Ptr<double> p2 = new double();

	push	8
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T39371[ebp], eax
	cmp	DWORD PTR $T39371[ebp], 0
	je	SHORT $LN5@main
	mov	eax, DWORD PTR $T39371[ebp]
	fldz
	fstp	QWORD PTR [eax]
	mov	ecx, DWORD PTR $T39371[ebp]
...
$LN6@main:
	...
	call	??0?$Ptr@N@Ex29@@QAE@PAN@Z		; Ex29::Ptr<double>::Ptr<double>
	mov	BYTE PTR __$EHRec$[ebp+8], 1

; 44   : 	
; 45   : 	Ptr<int> p3 = new int();

	push	4
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T39374[ebp], eax
	cmp	DWORD PTR $T39374[ebp], 0
	je	SHORT $LN7@main
	mov	eax, DWORD PTR $T39374[ebp]
	mov	DWORD PTR [eax], 0
	mov	ecx, DWORD PTR $T39374[ebp]
...
; 47   : 	Ptr<int> p4 = p3;
	...
	call	??0?$Ptr@H@Ex29@@QAE@AAV01@@Z		; Ex29::Ptr<int>::Ptr<int>
...
; 51   : 	int i = 234;
	...
	mov	DWORD PTR _i$[ebp], 234			; 000000eaH

; 52   : 
; 53   : 	TraversePointers();

	call	?TraversePointers@Ex29@@YAXXZ		; Ex29::TraversePointers
...
; 55   : }
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR _p5$[ebp]
	call	??1?$Ptr@N@Ex29@@QAE@XZ			; Ex29::Ptr<double>::~Ptr<double>
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR _p4$[ebp]
	call	??1?$Ptr@H@Ex29@@QAE@XZ			; Ex29::Ptr<int>::~Ptr<int>
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR _p3$[ebp]
	call	??1?$Ptr@H@Ex29@@QAE@XZ			; Ex29::Ptr<int>::~Ptr<int>
...
__unwindfunclet$_main$0:
	lea	ecx, DWORD PTR _p1$[ebp]
	jmp	??1?$Ptr@H@Ex29@@QAE@XZ			; Ex29::Ptr<int>::~Ptr<int>
__unwindfunclet$_main$1:
	lea	ecx, DWORD PTR _p2$[ebp]
	jmp	??1?$Ptr@N@Ex29@@QAE@XZ			; Ex29::Ptr<double>::~Ptr<double>
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e29.cpp
;	COMDAT ??0?$Ptr@H@Ex29@@QAE@PAH@Z
_TEXT	SEGMENT
$T39412 = -212						; size = 4
_this$ = -8						; size = 4
_p$ = 8							; size = 4
??0?$Ptr@H@Ex29@@QAE@PAH@Z PROC				; Ex29::Ptr<int>::Ptr<int>, COMDAT
; _this$ = ecx
...
; 25   : 		}
	...
	pop	ebp
	ret	4
??0?$Ptr@H@Ex29@@QAE@PAH@Z ENDP				; Ex29::Ptr<int>::Ptr<int>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??0?$Ptr@H@Ex29@@QAE@AAV01@@Z
_TEXT	SEGMENT
$T39415 = -212						; size = 4
_this$ = -8						; size = 4
_rhs$ = 8						; size = 4
??0?$Ptr@H@Ex29@@QAE@AAV01@@Z PROC			; Ex29::Ptr<int>::Ptr<int>, COMDAT
; _this$ = ecx
...
; 28   : 			stack.push_back((void**) &m_p); 

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T39415[ebp], eax
...
; 29   : 		}
	...
	pop	ebp
	ret	4
??0?$Ptr@H@Ex29@@QAE@AAV01@@Z ENDP			; Ex29::Ptr<int>::Ptr<int>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??1?$Ptr@H@Ex29@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1?$Ptr@H@Ex29@@QAE@XZ PROC				; Ex29::Ptr<int>::~Ptr<int>, COMDAT
; _this$ = ecx
...
; 33   : 		}
	...
	pop	ebp
	ret	0
??1?$Ptr@H@Ex29@@QAE@XZ ENDP				; Ex29::Ptr<int>::~Ptr<int>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??0?$Ptr@N@Ex29@@QAE@PAN@Z
_TEXT	SEGMENT
$T39420 = -212						; size = 4
_this$ = -8						; size = 4
_p$ = 8							; size = 4
??0?$Ptr@N@Ex29@@QAE@PAN@Z PROC				; Ex29::Ptr<double>::Ptr<double>, COMDAT
; _this$ = ecx
...
; 25   : 		}
	...
	pop	ebp
	ret	4
??0?$Ptr@N@Ex29@@QAE@PAN@Z ENDP				; Ex29::Ptr<double>::Ptr<double>
; Function compile flags: /Odtp /RTCsu /ZI
_TEXT	ENDS
;	COMDAT ??1?$Ptr@N@Ex29@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1?$Ptr@N@Ex29@@QAE@XZ PROC				; Ex29::Ptr<double>::~Ptr<double>, COMDAT
; _this$ = ecx
...
; 33   : 		}
	...
	pop	ebp
	ret	0
??1?$Ptr@N@Ex29@@QAE@XZ ENDP				; Ex29::Ptr<double>::~Ptr<double>
_TEXT	ENDS
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sub	eax, DWORD PTR [ecx+4]
	sar	eax, 2
	mov	DWORD PTR __Idx$35029[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR __Idx$35029[ebp]
	lea	eax, DWORD PTR [ecx+edx*4]
	push	eax
...
_TEXT	SEGMENT
__Size$35830 = -48					; size = 4
__Ptr$35823 = -36					; size = 4
_this$ = -24						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$35823[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	eax, DWORD PTR __Ptr$35823[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	push	edx
...
; 756  : 			this->_Alval.deallocate(_Ptr, _Count);
	...
	mov	eax, DWORD PTR __Count$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Ptr$35823[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@QBEIXZ ; std::vector<void * *,std::allocator<void * *> >::size
	mov	DWORD PTR __Size$35830[ebp], eax
...
; 770  : 			this->_Mylast = _Ptr + _Size;
	...
	mov	eax, DWORD PTR __Size$35830[ebp]
	mov	ecx, DWORD PTR __Ptr$35823[ebp]
	lea	edx, DWORD PTR [ecx+eax*4]
	mov	eax, DWORD PTR _this$[ebp]
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T39487[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T39488[ebp], edx
	lea	eax, DWORD PTR $T39487[ebp]
	push	eax
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T39489[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T39490[ebp], edx
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T39491[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T39491[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T39552[ebp], al
	movzx	edx, BYTE PTR $T39552[ebp]
	push	edx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@PAPAXPAPAX@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAPAX0@Z ; std::_Ptr_cat<void * *,void * *>
	add	esp, 8
	mov	BYTE PTR $T39593[ebp], al
	movzx	edx, BYTE PTR $T39593[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e29.cpp
;	COMDAT ??__Estack@Ex29@@YAXXZ
text$yc	SEGMENT
??__Estack@Ex29@@YAXXZ PROC				; Ex29::`dynamic initializer for 'stack'', COMDAT
...
; 7    : 	vector<void**> stack;
	...
	push	OFFSET ??__Fstack@Ex29@@YAXXZ		; Ex29::`dynamic atexit destructor for 'stack''
	call	_atexit
	add	esp, 4
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
??__Estack@Ex29@@YAXXZ ENDP				; Ex29::`dynamic initializer for 'stack''
text$yc	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??__Fstack@Ex29@@YAXXZ
text$yd	SEGMENT
??__Fstack@Ex29@@YAXXZ PROC				; Ex29::`dynamic atexit destructor for 'stack'', COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	push	ebx
	...
	pop	ebp
	ret	0
??__Fstack@Ex29@@YAXXZ ENDP				; Ex29::`dynamic atexit destructor for 'stack''
text$yd	ENDS
...
_TEXT	ENDS
PUBLIC	?stack@Ex29@@3V?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@A ; Ex29::stack
_BSS	SEGMENT
?stack@Ex29@@3V?$vector@PAPAXV?$allocator@PAPAX@std@@@std@@A DB 014H DUP (?) ; Ex29::stack
_BSS	ENDS
CRT$XCU	SEGMENT
_stack$initializer$ DD FLAT:??__Estack@Ex29@@YAXXZ
CRT$XCU	ENDS
END
