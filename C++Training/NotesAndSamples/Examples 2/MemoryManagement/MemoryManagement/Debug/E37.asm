; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E37.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?fun@SA@Ex37@@QAEXXZ				; Ex37::SA::fun
PUBLIC	??0SA@Ex37@@QAE@XZ				; Ex37::SA::SA
PUBLIC	?main37@@YAXXZ					; main37
...
;	COMDAT xdata$x
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e37.cpp
xdata$x	SEGMENT
__unwindtable$?main37@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?main37@@YAXXZ$0
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?main37@@YAXXZ$1
__ehfuncinfo$?main37@@YAXXZ DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?main37@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_p$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
?main37@@YAXXZ PROC					; main37, COMDAT
...
; 35   : 	SA* p;				//default
; 36   : 	
; 37   : 	SA* p2 = new SA;	//overloaded

	push	1
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T30105[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T30105[ebp], 0
	je	SHORT $LN3@main37
	mov	ecx, DWORD PTR $T30105[ebp]
	call	??0SA@Ex37@@QAE@XZ			; Ex37::SA::SA
	mov	DWORD PTR tv71[ebp], eax
	jmp	SHORT $LN4@main37
$LN3@main37:
	mov	DWORD PTR tv71[ebp], 0
$LN4@main37:
	mov	eax, DWORD PTR tv71[ebp]
	mov	DWORD PTR $T30104[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T30104[ebp]
...
; 40   : 
; 41   : 	p = new SA;		//overloaded assignment operator

	push	1
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T30109[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T30109[ebp], 0
	je	SHORT $LN5@main37
	mov	ecx, DWORD PTR $T30109[ebp]
	call	??0SA@Ex37@@QAE@XZ			; Ex37::SA::SA
	mov	DWORD PTR tv78[ebp], eax
	jmp	SHORT $LN6@main37
$LN5@main37:
	mov	DWORD PTR tv78[ebp], 0
$LN6@main37:
	mov	eax, DWORD PTR tv78[ebp]
	mov	DWORD PTR $T30108[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T30108[ebp]
	mov	DWORD PTR _p$[ebp], ecx

; 42   : 
; 43   : 	p2 = p;			    //assignment operator
...
; 45   : 	p2->fun();
	...
	call	?fun@SA@Ex37@@QAEXXZ			; Ex37::SA::fun
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?main37@@YAXXZ$0:
	mov	eax, DWORD PTR $T30105[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?main37@@YAXXZ$1:
	mov	eax, DWORD PTR $T30109[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?main37@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-296]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?main37@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?main37@@YAXXZ ENDP					; main37
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??0SA@Ex37@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0SA@Ex37@@QAE@XZ PROC					; Ex37::SA::SA, COMDAT
; _this$ = ecx
...
; 9    : 		SA()			{		cout<<"SA created"<<endl;		}
	...
	pop	ebp
	ret	0
??0SA@Ex37@@QAE@XZ ENDP					; Ex37::SA::SA
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?fun@SA@Ex37@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?fun@SA@Ex37@@QAEXXZ PROC				; Ex37::SA::fun, COMDAT
; _this$ = ecx
...
; 10   : 		void fun()	{		cout<<"fun executed"<<endl;	}
	...
	pop	ebp
	ret	0
?fun@SA@Ex37@@QAEXXZ ENDP				; Ex37::SA::fun
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30142[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30143[ebp], edx
	lea	eax, DWORD PTR $T30142[ebp]
	push	eax
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30144[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30145[ebp], edx
	lea	eax, DWORD PTR $T30144[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30145[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30146[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30146[ebp]
