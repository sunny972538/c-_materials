; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E32.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0BA@MLNACKPC@couldnt?5destroy?$AA@	; `string'
PUBLIC	??_GCA@Ex32@@QAEPAXI@Z				; Ex32::CA::`scalar deleting destructor'
PUBLIC	?main32@@YAXXZ					; main32
...
;	COMDAT ??_R0PAD@8
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e32.cpp
_DATA	SEGMENT
??_R0PAD@8 DD	FLAT:??_7type_info@@6B@			; char * `RTTI Type Descriptor'
	DD	00H
	DB	'.PAD', 00H
_DATA	ENDS
;	COMDAT ??_C@_0BA@MLNACKPC@couldnt?5destroy?$AA@
CONST	SEGMENT
??_C@_0BA@MLNACKPC@couldnt?5destroy?$AA@ DB 'couldnt destroy', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
__catchsym$?main32@@YAXXZ$2 DD 00H
	DD	FLAT:??_R0PAD@8
	DD	00H
	DD	FLAT:__catch$?main32@@YAXXZ$0
__unwindtable$?main32@@YAXXZ DD 0ffffffffH
	DD	00H
	DD	0ffffffffH
	DD	00H
__tryblocktable$?main32@@YAXXZ DD 00H
	DD	00H
	DD	01H
	DD	01H
	DD	FLAT:__catchsym$?main32@@YAXXZ$2
__ehfuncinfo$?main32@@YAXXZ DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?main32@@YAXXZ
	DD	01H
	DD	FLAT:__tryblocktable$?main32@@YAXXZ
	DD	2 DUP(00H)
	DD	00H
	DD	01H
xdata$x	ENDS
...
_p$ = -24						; size = 4
__$EHRec$ = -16						; size = 16
?main32@@YAXXZ PROC					; main32, COMDAT
...
; 19   : 	CA *p = new CA();
	...
	add	esp, 4
	mov	DWORD PTR $T30073[ebp], eax
	cmp	DWORD PTR $T30073[ebp], 0
	je	SHORT $LN4@main32
	mov	eax, DWORD PTR $T30073[ebp]
	mov	DWORD PTR tv67[ebp], eax
	jmp	SHORT $LN5@main32
$LN4@main32:
...
; 23   : 		delete p;
	...
	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR $T30077[ebp], eax
	mov	ecx, DWORD PTR $T30077[ebp]
	mov	DWORD PTR $T30076[ebp], ecx
	cmp	DWORD PTR $T30076[ebp], 0
	je	SHORT $LN6@main32
	push	1
	mov	ecx, DWORD PTR $T30076[ebp]
	call	??_GCA@Ex32@@QAEPAXI@Z
	mov	DWORD PTR tv84[ebp], eax
	mov	edx, DWORD PTR tv84[ebp]
	mov	DWORD PTR tv72[ebp], edx
	jmp	SHORT $LN7@main32
$LN6@main32:
	mov	DWORD PTR tv72[ebp], 0
$LN7@main32:
	jmp	SHORT $LN10@main32
__catch$?main32@@YAXXZ$0:

; 24   : 	}catch(char*)	{		cout<<"couldnt destroy"<<endl;	}

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0BA@MLNACKPC@couldnt?5destroy?$AA@
	...
	mov	eax, __tryend$?main32@@YAXXZ$1
	ret	0
$LN10@main32:
	mov	DWORD PTR __$EHRec$[ebp+12], -1
__tryend$?main32@@YAXXZ$1:
...
; 27   : 	delete p;
	...
	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR $T30081[ebp], eax
	mov	ecx, DWORD PTR $T30081[ebp]
	mov	DWORD PTR $T30080[ebp], ecx
	cmp	DWORD PTR $T30080[ebp], 0
	je	SHORT $LN8@main32
	push	1
	mov	ecx, DWORD PTR $T30080[ebp]
	call	??_GCA@Ex32@@QAEPAXI@Z
	mov	DWORD PTR tv82[ebp], eax
	jmp	SHORT $LN2@main32
$LN8@main32:
...
;	COMDAT text$x
text$x	SEGMENT
__ehhandler$?main32@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-292]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?main32@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?main32@@YAXXZ ENDP					; main32
PUBLIC	??1CA@Ex32@@QAE@XZ				; Ex32::CA::~CA
EXTRN	??3@YAXPAX@Z:PROC				; operator delete
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??_GCA@Ex32@@QAEPAXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
___flags$ = 8						; size = 4
??_GCA@Ex32@@QAEPAXI@Z PROC				; Ex32::CA::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	...
	call	??1CA@Ex32@@QAE@XZ			; Ex32::CA::~CA
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GCA@Ex32@@QAEPAXI@Z ENDP				; Ex32::CA::`scalar deleting destructor'
_TEXT	ENDS
PUBLIC	??_C@_0N@CNKEDGNC@CA?5destroyed?$AA@		; `string'
PUBLIC	__TI2PAD
PUBLIC	??_C@_0O@IBDEICAJ@Invalid?5State?$AA@		; `string'
PUBLIC	__CTA2PAD
...
xdata$x	ENDS
;	COMDAT ??_C@_0N@CNKEDGNC@CA?5destroyed?$AA@
CONST	SEGMENT
??_C@_0N@CNKEDGNC@CA?5destroyed?$AA@ DB 'CA destroyed', 00H ; `string'
CONST	ENDS
;	COMDAT __TI2PAD
xdata$x	SEGMENT
__TI2PAD DD	00H
	...
	DD	FLAT:__CTA2PAD
xdata$x	ENDS
;	COMDAT ??_C@_0O@IBDEICAJ@Invalid?5State?$AA@
CONST	SEGMENT
??_C@_0O@IBDEICAJ@Invalid?5State?$AA@ DB 'Invalid State', 00H ; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??1CA@Ex32@@QAE@XZ
_TEXT	SEGMENT
$T30115 = -212						; size = 4
_this$ = -8						; size = 4
??1CA@Ex32@@QAE@XZ PROC					; Ex32::CA::~CA, COMDAT
; _this$ = ecx
...
; 11   : 			if(flag==true) throw "Invalid State";

	mov	eax, DWORD PTR _this$[ebp]
	movzx	ecx, BYTE PTR [eax]
	cmp	ecx, 1
	jne	SHORT $LN1@CA
	mov	DWORD PTR $T30115[ebp], OFFSET ??_C@_0O@IBDEICAJ@Invalid?5State?$AA@
...
; 12   : 
; 13   : 			cout<<"CA destroyed"<<endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0N@CNKEDGNC@CA?5destroyed?$AA@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 14   : 		}
	...
	pop	ebp
	ret	0
??1CA@Ex32@@QAE@XZ ENDP					; Ex32::CA::~CA
_TEXT	ENDS
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30123[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30124[ebp], edx
	lea	eax, DWORD PTR $T30123[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30124[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30125[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30125[ebp]
