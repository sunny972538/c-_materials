; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E23.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?g_isOnHeap@SA@Ex23@@2_NA			; Ex23::SA::g_isOnHeap
_BSS	SEGMENT
?g_isOnHeap@SA@Ex23@@2_NA DB 01H DUP (?)		; Ex23::SA::g_isOnHeap
_BSS	ENDS
...
CONST	ENDS
PUBLIC	?doJob@SA@Ex23@@QAEXXZ				; Ex23::SA::doJob
PUBLIC	??2SA@Ex23@@SAPAXI@Z				; Ex23::SA::operator new
PUBLIC	??0SA@Ex23@@QAE@XZ				; Ex23::SA::SA
PUBLIC	?main23@@YAXXZ					; main23
...
;	COMDAT xdata$x
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e23.cpp
xdata$x	SEGMENT
__unwindtable$?main23@@YAXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?main23@@YAXXZ$0
__ehfuncinfo$?main23@@YAXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?main23@@YAXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
$T30058 = -248						; size = 4
$T30059 = -236						; size = 4
_heapObject$ = -32					; size = 4
_stackObject$ = -17					; size = 1
__$EHRec$ = -12						; size = 12
?main23@@YAXXZ PROC					; main23, COMDAT
...
; 36   : 	SA stackObject;	
	...
	lea	ecx, DWORD PTR _stackObject$[ebp]
	call	??0SA@Ex23@@QAE@XZ			; Ex23::SA::SA

; 37   : 	//	stackObject::SA::SA(); 
; 38   : 
; 39   : 	SA *heapObject = new SA(); 

	push	1
	call	??2SA@Ex23@@SAPAXI@Z			; Ex23::SA::operator new
	add	esp, 4
	mov	DWORD PTR $T30059[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T30059[ebp], 0
	je	SHORT $LN3@main23
	mov	ecx, DWORD PTR $T30059[ebp]
	call	??0SA@Ex23@@QAE@XZ			; Ex23::SA::SA
	mov	DWORD PTR tv72[ebp], eax
	jmp	SHORT $LN4@main23
$LN3@main23:
...
$LN4@main23:
	...
	mov	DWORD PTR _heapObject$[ebp], ecx

; 40   : 	/*
; 41   : 		SA *p = SA::operator new(sizeof(SA)); 
; 42   : 		p->SA::SA();				
; 43   : 	*/
; 44   : 	stackObject.doJob();

	lea	ecx, DWORD PTR _stackObject$[ebp]
	call	?doJob@SA@Ex23@@QAEXXZ			; Ex23::SA::doJob

; 45   : 	heapObject->doJob();

	mov	ecx, DWORD PTR _heapObject$[ebp]
	call	?doJob@SA@Ex23@@QAEXXZ			; Ex23::SA::doJob
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?main23@@YAXXZ$0:
	mov	eax, DWORD PTR $T30059[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?main23@@YAXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-260]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?main23@@YAXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?main23@@YAXXZ ENDP					; main23
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??0SA@Ex23@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0SA@Ex23@@QAE@XZ PROC					; Ex23::SA::SA, COMDAT
; _this$ = ecx
...
; 14   : 			m_isOnHeap = g_isOnHeap;
	...
	mov	cl, BYTE PTR ?g_isOnHeap@SA@Ex23@@2_NA	; Ex23::SA::g_isOnHeap
	mov	BYTE PTR [eax], cl

; 15   : 			g_isOnHeap = false;

	mov	BYTE PTR ?g_isOnHeap@SA@Ex23@@2_NA, 0	; Ex23::SA::g_isOnHeap
...
; 16   : 		}
	...
	pop	ebp
	ret	0
??0SA@Ex23@@QAE@XZ ENDP					; Ex23::SA::SA
_TEXT	ENDS
EXTRN	__imp__malloc:PROC
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??2SA@Ex23@@SAPAXI@Z
_TEXT	SEGMENT
_size$ = 8						; size = 4
??2SA@Ex23@@SAPAXI@Z PROC				; Ex23::SA::operator new, COMDAT
...
; 19   : 			g_isOnHeap = true;
	...
	mov	BYTE PTR ?g_isOnHeap@SA@Ex23@@2_NA, 1	; Ex23::SA::g_isOnHeap
...
; 21   : 		}
	...
	pop	ebp
	ret	0
??2SA@Ex23@@SAPAXI@Z ENDP				; Ex23::SA::operator new
_TEXT	ENDS
PUBLIC	??_C@_0BD@CEFCNDIO@object?5is?5on?5stack?$AA@	; `string'
PUBLIC	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
PUBLIC	??_C@_0BC@KCGKEHNI@object?5is?5on?5heap?$AA@	; `string'
EXTRN	__imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QAEAAV01@P6AAAV01@AAV01@@Z@Z:PROC
EXTRN	__imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A:BYTE
EXTRN	__imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z:PROC
;	COMDAT ??_C@_0BD@CEFCNDIO@object?5is?5on?5stack?$AA@
CONST	SEGMENT
??_C@_0BD@CEFCNDIO@object?5is?5on?5stack?$AA@ DB 'object is on stack', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@KCGKEHNI@object?5is?5on?5heap?$AA@
CONST	SEGMENT
??_C@_0BC@KCGKEHNI@object?5is?5on?5heap?$AA@ DB 'object is on heap', 00H ; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?doJob@SA@Ex23@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?doJob@SA@Ex23@@QAEXXZ PROC				; Ex23::SA::doJob, COMDAT
; _this$ = ecx
...
; 25   : 				cout<<"object is on heap"<<endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0BC@KCGKEHNI@object?5is?5on?5heap?$AA@
...
; 27   : 				cout<<"object is on stack"<<endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0BD@CEFCNDIO@object?5is?5on?5stack?$AA@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 28   : 		}
	...
	pop	ebp
	ret	0
?doJob@SA@Ex23@@QAEXXZ ENDP				; Ex23::SA::doJob
_TEXT	ENDS
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30099[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30100[ebp], edx
	lea	eax, DWORD PTR $T30099[ebp]
	push	eax
