; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E14.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?flag@Ex14@@3UFlag@1@A				; Ex14::flag
...
_BSS	SEGMENT
?flag@Ex14@@3UFlag@1@A DB 01H DUP (?)			; Ex14::flag
_BSS	ENDS
...
CONST	ENDS
PUBLIC	??2SA@Ex14@@SAPAXIHH@Z				; Ex14::SA::operator new
PUBLIC	??2SA@Ex14@@SAPAXIUFlag@1@@Z			; Ex14::SA::operator new
PUBLIC	??2SA@Ex14@@SAPAXIZZ				; Ex14::SA::operator new
PUBLIC	_main
...
;	COMDAT rtc$TMZ
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e14.cpp
rtc$TMZ	SEGMENT
...
; 32   : 	SA *p = new SA(); 
	...
	mov	DWORD PTR $T30082[ebp], 1
	mov	eax, DWORD PTR $T30082[ebp]
	push	eax
	call	??2SA@Ex14@@SAPAXIZZ			; Ex14::SA::operator new
	add	esp, 4
	mov	DWORD PTR $T30083[ebp], eax
	cmp	DWORD PTR $T30083[ebp], 0
	je	SHORT $LN3@main
	mov	ecx, DWORD PTR $T30082[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR $T30083[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
	mov	eax, DWORD PTR $T30083[ebp]
...
; 33   : 	/*
; 34   : 	SA *p = SA::operator new(sizeof(SA));
; 35   : 	p->SA::SA();
; 36   : 	*/
; 37   : 	SA *p2 = new(flag) SA();

	mov	DWORD PTR $T30086[ebp], 1
	movzx	eax, BYTE PTR ?flag@Ex14@@3UFlag@1@A	; Ex14::flag
	push	eax
	mov	ecx, DWORD PTR $T30086[ebp]
	push	ecx
	call	??2SA@Ex14@@SAPAXIUFlag@1@@Z		; Ex14::SA::operator new
	add	esp, 8
	mov	DWORD PTR $T30087[ebp], eax
	cmp	DWORD PTR $T30087[ebp], 0
	je	SHORT $LN5@main
	mov	edx, DWORD PTR $T30086[ebp]
	push	edx
	push	0
	mov	eax, DWORD PTR $T30087[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
	mov	ecx, DWORD PTR $T30087[ebp]
...
; 38   : 	/*
; 39   : 	SA *p2 = SA::operator new(sizeof(SA),flag);
; 40   : 	p2->SA::SA();
; 41   : 	*/
; 42   : 	SA *p3 = new(10,20) SA();

	mov	DWORD PTR $T30090[ebp], 1
	push	20					; 00000014H
	push	10					; 0000000aH
	mov	eax, DWORD PTR $T30090[ebp]
	push	eax
	call	??2SA@Ex14@@SAPAXIHH@Z			; Ex14::SA::operator new
	add	esp, 12					; 0000000cH
	mov	DWORD PTR $T30091[ebp], eax
	cmp	DWORD PTR $T30091[ebp], 0
	je	SHORT $LN7@main
	mov	ecx, DWORD PTR $T30090[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR $T30091[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
	mov	eax, DWORD PTR $T30091[ebp]
...
; 43   : 	/*
; 44   : 	SA *p2 = SA::operator new(sizeof(SA),10,20);
; 45   : 	p2->SA::SA();
; 46   : 	*/
; 47   : 	SA *p4 = new(23,34,345,45,56) SA();

	mov	DWORD PTR $T30094[ebp], 1
	push	56					; 00000038H
	push	45					; 0000002dH
	push	345					; 00000159H
	push	34					; 00000022H
	push	23					; 00000017H
	mov	eax, DWORD PTR $T30094[ebp]
	push	eax
	call	??2SA@Ex14@@SAPAXIZZ			; Ex14::SA::operator new
	add	esp, 24					; 00000018H
	mov	DWORD PTR $T30095[ebp], eax
	cmp	DWORD PTR $T30095[ebp], 0
	je	SHORT $LN9@main
	mov	ecx, DWORD PTR $T30094[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR $T30095[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
	mov	eax, DWORD PTR $T30095[ebp]
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??2SA@Ex14@@SAPAXIUFlag@1@@Z
_TEXT	SEGMENT
_size$ = 8						; size = 4
___formal$ = 12						; size = 1
??2SA@Ex14@@SAPAXIUFlag@1@@Z PROC			; Ex14::SA::operator new, COMDAT
...
; 13   : 			cout<<"SA new operator with flag"<<endl;
...
; 15   : 		}
	...
	pop	ebp
	ret	0
??2SA@Ex14@@SAPAXIUFlag@1@@Z ENDP			; Ex14::SA::operator new
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??2SA@Ex14@@SAPAXIHH@Z
_TEXT	SEGMENT
_size$ = 8						; size = 4
_x$ = 12						; size = 4
_y$ = 16						; size = 4
??2SA@Ex14@@SAPAXIHH@Z PROC				; Ex14::SA::operator new, COMDAT
...
; 18   : 			cout<<"SA new operator 3"<<endl;
...
; 20   : 		}
	...
	pop	ebp
	ret	0
??2SA@Ex14@@SAPAXIHH@Z ENDP				; Ex14::SA::operator new
_TEXT	ENDS
PUBLIC	??_C@_0BC@HKLDIJOO@SA?5new?5operator?54?$AA@	; `string'
;	COMDAT ??_C@_0BC@HKLDIJOO@SA?5new?5operator?54?$AA@
CONST	SEGMENT
??_C@_0BC@HKLDIJOO@SA?5new?5operator?54?$AA@ DB 'SA new operator 4', 00H ; `string'
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ??2SA@Ex14@@SAPAXIZZ
_TEXT	SEGMENT
_size$ = 8						; size = 4
??2SA@Ex14@@SAPAXIZZ PROC				; Ex14::SA::operator new, COMDAT
...
; 23   : 			cout<<"SA new operator 4"<<endl;

	mov	esi, esp
	mov	eax, DWORD PTR __imp_?endl@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@1@AAV21@@Z
	push	eax
	push	OFFSET ??_C@_0BC@HKLDIJOO@SA?5new?5operator?54?$AA@
	mov	ecx, DWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	push	ecx
	call	??$?6U?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@PBD@Z ; std::operator<<<std::char_traits<char> >
	add	esp, 8
...
; 25   : 		}
	...
	pop	ebp
	ret	0
??2SA@Ex14@@SAPAXIZZ ENDP				; Ex14::SA::operator new
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30119[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30120[ebp], edx
	lea	eax, DWORD PTR $T30119[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30120[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30121[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30122[ebp], edx
