; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E09.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e09.cpp
_DATA	SEGMENT
...
; 24   : 		return ;
	...
	lea	ecx, DWORD PTR _e$23058[ebp]
...
; 29   : 	delete p;
	...
	mov	DWORD PTR $T30040[ebp], eax
	mov	ecx, DWORD PTR $T30040[ebp]
	push	ecx
...
__unwindfunclet$_main$2:
	lea	ecx, DWORD PTR _e$23058[ebp]
	jmp	??1bad_alloc@std@@UAE@XZ		; std::bad_alloc::~bad_alloc
__ehhandler$_main:
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30082[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30083[ebp], edx
	lea	eax, DWORD PTR $T30082[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30083[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30084[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30085[ebp], edx
	lea	eax, DWORD PTR $T30084[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30085[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30086[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30086[ebp]
