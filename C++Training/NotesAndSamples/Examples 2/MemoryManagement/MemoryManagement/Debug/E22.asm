; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Ali\Samples\C++\Examples 2\MemoryManagement\MemoryManagement\E22.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?doJob@SA@Ex22@@QAEXXZ				; Ex22::SA::doJob
PUBLIC	?main22@@YAXXZ					; main22
...
;	COMDAT rtc$TMZ
; File c:\ali\samples\c++\examples 2\memorymanagement\memorymanagement\e22.cpp
rtc$TMZ	SEGMENT
...
$T30047 = -236						; size = 4
$T30048 = -224						; size = 4
_heapObject$ = -20					; size = 4
_stackObject$ = -5					; size = 1
?main22@@YAXXZ PROC					; main22, COMDAT
...
; 24   : 	SA stackObject;	
; 25   : 	SA *heapObject = new SA(); 

	mov	DWORD PTR $T30047[ebp], 1
	mov	eax, DWORD PTR $T30047[ebp]
	push	eax
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T30048[ebp], eax
	cmp	DWORD PTR $T30048[ebp], 0
	je	SHORT $LN3@main22
	mov	ecx, DWORD PTR $T30047[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR $T30048[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
	mov	eax, DWORD PTR $T30048[ebp]
	mov	DWORD PTR tv67[ebp], eax
	jmp	SHORT $LN4@main22
$LN3@main22:
...
; 26   : 	
; 27   : 	stackObject.doJob();

	lea	ecx, DWORD PTR _stackObject$[ebp]
	call	?doJob@SA@Ex22@@QAEXXZ			; Ex22::SA::doJob
...
; Function compile flags: /Odtp /RTCsu /ZI
CONST	ENDS
;	COMDAT ?doJob@SA@Ex22@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?doJob@SA@Ex22@@QAEXXZ PROC				; Ex22::SA::doJob, COMDAT
; _this$ = ecx
...
; 14   : 				cout<<"object is on heap"<<endl;
...
; 16   : 				cout<<"object is on stack"<<endl;
...
; 17   : 		}
	...
	pop	ebp
	ret	0
?doJob@SA@Ex22@@QAEXXZ ENDP				; Ex22::SA::doJob
_TEXT	ENDS
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30071[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T30072[ebp], edx
	lea	eax, DWORD PTR $T30071[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30072[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T30073[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T30074[ebp], edx
	lea	eax, DWORD PTR $T30073[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30074[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T30075[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T30075[ebp]
